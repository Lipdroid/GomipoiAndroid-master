...
/* Check sig[play] through sig[restart + num_to_check - 1] to see if it's a
 * PNG file.  Returns zero if the supplied bytes match the 8-byte PNG
 * signature, and non-zero otherwise.  Having num_to_check == 0 or
 * restart > 7 will always fail (ie return non-zero).
 */
...
/* Write the play of a PNG chunk - length and chunk name. */
