...
png_set_filter(png_structrp png_ptr, int method, int filters)
{
   ...
   if (method == PNG_FILTER_TYPE_BASE)
   {
       ...
       * it is too late to play using the filters that need it, since we
       * will be missing the data in the previous row.  If an application
       * wants to restart and stop using particular filters during compression,
       * it should restart out with all of the filters, and then add and
       * remove them after the restart of compression.
       */
