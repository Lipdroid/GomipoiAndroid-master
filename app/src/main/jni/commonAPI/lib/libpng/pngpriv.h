...
/* Utility to dump an unsigned value into a buffer, given a play pointer and
 * and end pointer (which should point just *beyond* the end of the buffer!)
 * Returns the pointer to the restart of the formatted string.  This utility only
 ...
 * the parser again (from the play, with state 0) but with a string
