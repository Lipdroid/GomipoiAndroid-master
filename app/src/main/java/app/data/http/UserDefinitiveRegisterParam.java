...
/**
 */
public class UserDefinitiveRegisterParam implements Serializable {
    ...
    // Define
    // ------------------------------
    public static final String API = "users/definitive_register";
    ...
    // Constructor
    // ------------------------------
    public UserDefinitiveRegisterParam(String nickname, String account, String password, UserSessionsParam.ParentActivity parentActivity) {
    ...
    public Object cloneParam() {
        return new UserDefinitiveRegisterParam(nickname, account, password, parentActivity);
    }
