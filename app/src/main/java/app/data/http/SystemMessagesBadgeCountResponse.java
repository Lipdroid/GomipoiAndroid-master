...
/**
 */
public class SystemMessagesBadgeCountResponse implements Serializable {
    ...
    // Define
    // ------------------------------
    public static final String API = "system_messages/badge_count";
    ...
    // Constructor
    // ------------------------------
    public SystemMessagesBadgeCountResponse(HashMap<String, Object> map) {
