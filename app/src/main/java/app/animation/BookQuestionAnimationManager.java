 ...
 *
 */
public class BookQuestionAnimationManager extends ViewAnimationManager {

	// ------------------------------
	// Member
	// ------------------------------
	private long mDurationTime = 1000L;
	private long mOffsetTime = 0L;
	 ...
	 * @param listener
	 */
	public BookQuestionAnimationManager(int animationCode, View view,
	...
	public Animation createViewAnimation() {
		...
		AlphaAnimation alphaAnim = new AlphaAnimation(0.2f, 1);
